       ...
       <div className="w-screen h-screen flex justify-center items-center bg-[#0F0F0F]">
            ...
            <div className="flex items-center justify-between mt-4">
                ...
                <Link to="#" className="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">
                    or {signIn?'login':'sign up'} with Social Media
                </Link>
            ...
            <p className="mt-8 text-xs font-light text-center text-gray-400"> {signIn?"Don't have an account?":"Already have an account"} <span onClick={handleSign}  className="font-medium text-gray-700 dark:text-gray-200 hover:underline cursor-pointer">{signIn?'Create One':'Sign In'}</span></p>
            </div>
       </div>
    )
}